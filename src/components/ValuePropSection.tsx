          ...
          <div className="grid gap-3 sm:gap-4">
            {VALUE_PROP_HIGHLIGHTS.map((highlight, index) => (
              <Reveal key={index} delay={200 + (index * 100)}>
                <div className="group relative flex items-center p-3 sm:p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl border border-neutral-100 dark:border-neutral-700 shadow-sm hover:shadow-xl hover:border-primary-200 dark:hover:border-primary-700 hover:-translate-y-1.5 transition-all duration-300 ease-out cursor-pointer overflow-hidden">
